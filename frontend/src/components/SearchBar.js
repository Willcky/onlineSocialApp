...
function SearchBar(props) {
 ...
 const changeSearchType = (e) => {
   const searchType = e.target.value;//异步更新，e.target.value为当前点击的值
 ...
 const handleSearch = (value) => {
   ...
   setError("");
   props.handleSearch({ type: searchType, keyword: value });//home传下来的
 };
...
//radio, 时间代理，冒泡到radio.group，捕获到后onchange，并没有绑定event到单个radio上
